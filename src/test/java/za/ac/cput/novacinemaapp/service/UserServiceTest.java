...
class UserServiceTest {
    ...
    void setup() {
        user1 = UserFactory.buildUser("1","Mohamed","Shiiraar","mso2shiiraar@gmail.com","Test123!");
        assertNotNull(user1);
        System.out.println(user1);

        user2 = UserFactory.buildUser("2","Daanyaal","Isaacs","daanyaalisaacs@gmail.com","Test123!");
        assertNotNull(user2);
