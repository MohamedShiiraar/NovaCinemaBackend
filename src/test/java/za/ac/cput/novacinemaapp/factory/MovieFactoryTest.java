...
class MovieFactoryTest {
    @Test
    void testBuildMovie() {
        Movie b = MovieFactory.buildMovie("2","Cars","After the race at the Piston Cup Championship ends in a three-way tie-breaker, a rookie Lightning McQueen is desperate to make it to the winning position and take over the veteran Strip Weathers.","animation","117 mins","PG-13");
        assertNotNull(b);
